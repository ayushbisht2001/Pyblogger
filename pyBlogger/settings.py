"""
Django settings for pyBlogger project.
...
SECRET_KEY = '0^d)pltphnfee0^v1^naoaxqpx*k6=pbum%9!x4d4!=ra5h#vm'
...
WSGI_APPLICATION = 'pyBlogger.wsgi.application'
